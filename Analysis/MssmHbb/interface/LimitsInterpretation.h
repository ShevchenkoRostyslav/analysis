...
public:
	...
	LimitsInterpretation(const bool& blindData, const std::string& boson, const double& xMin = 200, const double& xMax = 900, const double& yMin = 0, const double& yMax = 60, const bool& test = false);
